...
<head>
	...
	<!-- title -->
	<title>Welcome!Sportylight!</title>

	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="/resources/images/layouts/logo.png">
	<!-- google font -->
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						...
						<h3>총 모집인원</h3>
						<a href="#" class="cart-btn"><i class="fa-solid fa-user-group"></i> ${total_headCount} 명</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						...
						<h3>현재 신청인원</h3>
						<a href="#" class="cart-btn"><i class="fa-solid fa-user-check"></i> ${total_joinCount} 명</a>
					</div>
				</div>
			</div>
		</div>
    	...
    	<div class="container">
        	<div class="row clearfix" style="align-items: center">
                ...
                <div class="content-column col-lg-6">
                    ...
                    <h4>전국별 모임현황</h4>
                    <div class="text">서두르세요. 신청마감이 얼마 남지 않았습니다. 다른 사람들이 선택한 인기 모임입니다.</div>
                    <!--Countdown Timer-->
                    <div class="time-counter"><div class="time-countdown clearfix" data-countdown="2020/2/01"><div class="counter-column"><div class="inner"><span class="count">00</span>Days</div></div> <div class="counter-column"><div class="inner"><span class="count">00</span>Hours</div></div>  <div class="counter-column"><div class="inner"><span class="count">00</span>Mins</div></div>  <div class="counter-column"><div class="inner"><span class="count">00</span>Secs</div></div></div></div>
                	<a href="cart.html" class="cart-btn mt-3"><i class="fa-brands fa-golang"></i> 모임신청</a>
                </div>
            </div>
        </div>
    </section>
